...
const articleData = [
    {id: 139433943, title: "The Future of Steel in Modern Construction", subheading: "How advanced steel solutions are shaping stronger, greener cities.", author: "Jeff Davis", publishDate: "2023-07-03", sections: [new ImageData("/img/potato.svg",500,500),loremIpsum]},
    {id: 546546567, title: "Why Steel Remains the Backbone of Infrastructure", subheading: "Exploring durability, versatility, and cost-efficiency in large-scale projects.", author: "Alexandra Dallon", publishDate: "2023-08-15", sections: [loremIpsum2]},
    {id: 234354657, title: "Sustainable Steel: Reducing the Carbon Footprint", subheading: "Innovations driving eco-friendly production in the steel industry.", author: "Maven Malone", publishDate: "2023-09-18", sections: [new ImageData("/img/croissant.svg"),loremIpsum3]},
    {id: 876879080, title: "Steel vs. Alternatives: The Strength Advantage", subheading: "Why steel outperforms wood, concrete, and composites in critical applications.", author: "Dominic Johannson", publishDate: "2023-12-06", sections: [loremIpsum,loremIpsum2]},
    {id: 354756445, title: "The Role of Steel in Renewable Energy", subheading: "Powering wind, solar, and hydro projects with high-performance materials.", author: "Eric Black", publishDate: "2024-01-01", sections: [loremIpsum3,loremIpsum2]},
    {id: 966767643, title: "From Mills to Markets: The Journey of Steel", subheading: "A behind-the-scenes look at how steel is produced, processed, and delivered.", author: "Priscilla Von Leyen", publishDate: "2024-01-12", sections: [loremIpsum2,loremIpsum3]},
    {id: 465768942, title: "Smart Steel: Technology in Manufacturing", subheading: "How AI, robotics, and automation are revolutionizing steel production.", author: "Aria Boltzmann", publishDate: "2024-02-26", sections: [new ImageData("/img/potato.svg"),loremIpsum2]},
    {id: 565757899, title: "Why Quality Steel Matters for Safety Standards", subheading: "The hidden impact of material integrity on construction and engineering.", author: "Alexandra Dallon", publishDate: "2024-03-05", sections: [new ImageData("/img/croissant.svg"),loremIpsum]},
    {id: 778553345, title: "Steel Recycling: Closing the Loop for a Circular Economy", subheading: "How recycled steel contributes to sustainability and cost savings.", author: "Jeff Davis", publishDate: "2024-03-09", sections: [new ImageData("/img/croissant.svg"),loremIpsum2,loremIpsum3]},
    {id: 669964533, title: "Steel Trends 2025: What to Expect", subheading: "Key innovations, market forecasts, and industry opportunities.", author: "Eric Black", publishDate: "2024-04-07", sections: [loremIpsum,loremIpsum2,loremIpsum3]}
]